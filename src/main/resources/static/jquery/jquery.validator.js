...
validator={
	...
	bigger : "this.checkBiggerThan(value)",// add by Mr.wangsh
	...
	checkBiggerThan:function(value){// add by Mr.wangsh
		var to = this['element'].attr('to');
...
validator.showErr=function (element, errindex){
	...
	element.parent('*').find('.'+this['validTip']).remove();//add by Mr.wangsh
	if(msgid.length>0) {
